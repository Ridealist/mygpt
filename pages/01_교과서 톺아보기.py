...
from keywords import create_keyword_textbook
...
with st.sidebar:
    ...
    #     "프롬프트 선택",
    #     ["prompts/doc-rag.yaml", "prompts/doc-quiz.yaml", "prompts/doc-summary.yaml"],
    #     index=0,
    # )
...
if uploaded_file:
    ...
    #TODO 키워드 질문 처리
    kw_1, kw_2 = create_keyword_textbook(st.session_state['messages'])
